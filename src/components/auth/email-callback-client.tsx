    ...
    <section className="rounded border border-zinc-800 bg-zinc-950 p-6 text-white shadow-2xl">
      ...
      {error ? (
        <div className="mt-6 grid gap-3 sm:grid-cols-2">
          <Link href={searchParams.get("next") === "/auth/update-password" ? "/auth/forgot-password?role=learner" : "/auth/login?role=learner"} className="lda-pill lda-pill-sm">
            {searchParams.get("next") === "/auth/update-password" ? "Reset learner password" : "Request learner link"}
          </Link>
          <Link href={searchParams.get("next") === "/auth/update-password" ? "/auth/forgot-password?role=instructor" : "/auth/login?role=instructor"} className="lda-pill lda-pill-sm">
            {searchParams.get("next") === "/auth/update-password" ? "Reset instructor password" : "Request instructor link"}
          </Link>
        </div>
      ) : (
